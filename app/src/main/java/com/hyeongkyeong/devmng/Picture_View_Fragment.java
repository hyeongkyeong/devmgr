...
public class Picture_View_Fragment extends Fragment implements OnTouchListener {

    private static final String TAG = "Picture_View_Activity";
    ...
    public Picture_View_Fragment() {
    }

    public Picture_View_Fragment(String category, ListItemData in_Data) {
        this_category = category;
        mId = in_Data.mId;  //장비 아이디
        mName = in_Data.mData[0];   //장비 명
        DatabaseHelper.openDatabase();
        mPicturesList = DatabaseHelper.getPictureFromName(CategoryManager.getTableName(category), mName);  //장비 사진 리스트
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sub_dir = CategoryManager.getPictureDirectory(this_category);
